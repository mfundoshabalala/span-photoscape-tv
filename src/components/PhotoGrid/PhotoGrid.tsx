    ...
    <div className="relative w-full h-full mx-auto">
      ...
      <div
        ...
        <div className="grid grid-flow-col auto-cols-max gap-2 h-full grid-rows-2 rounded-md">
          {photos.map((photo) => (
            <div key={photo.id} onClick={onImageFocus} className="border-2 border-transparent rounded-lg overflow-hidden aspect-video h-32 sm:h-48 md:h-64 lg:h-80 focus:border-purple-500">
              <img
